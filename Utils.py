...
def save_image_(pred_image,exp_name,image_name):
    ...
    for ind in range(batch_num):
        ...
        save_image(pred_image_images[ind], 'F:/datasets/feng_experiment/compare/{}/{}'.format(exp_name, image_name_1))
def store_image(pred_img,exp_name,img_name):
    ...
    for i in range(batch_num):
        ...
        path = 'F:/datasets/feng_experiment/compare/{}/{}'.format(exp_name, img_name[i])
