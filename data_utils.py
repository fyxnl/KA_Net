...
path=r'/home/sunshine/feng/fengdata/RESIDE/'
...
OTS_train_loader=DataLoader(dataset=RESIDE_Dataset(path+'/OTS',train=True,size= 224,format='.jpg'),batch_size=BS,shuffle=True)
OTS_test_loader=DataLoader(dataset=RESIDE_Dataset(path+'/SOTS/outdoor',train=False,size= 224,format='.png'),batch_size=1,shuffle=False)
